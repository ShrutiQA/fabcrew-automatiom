...
- Name: login.spec.ts >> Login Module >> Verify Password Eye icon is displayed
...
waiting for navigation until "load"
  navigated to "https://test-fab.aigeeks.dev/"
  navigated to "https://test-fab.aigeeks.dev/auth/login"
