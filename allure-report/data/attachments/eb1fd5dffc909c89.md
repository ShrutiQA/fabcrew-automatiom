...
- Name: login.spec.ts >> Login Module >> Verify "Password is required" validation message is displayed
- Location: tests\login.spec.ts:144:7
...
- generic [active] [ref=f1e1]:
  - generic [ref=f1e3]:
    - main [ref=f1e6]:
      - generic [ref=f1e9]:
        - img "auth image" [ref=f1e12]
        - main [ref=f1e13]:
          - generic:
            - img "FabCrew Logo"
          - main [ref=f1e15]:
            - generic [ref=f1e18]:
              - heading "Welcome Back" [level=1] [ref=f1e19]
              - generic [ref=f1e21]:
                - generic [ref=f1e22]: Email
                - textbox "Enter your email" [ref=f1e25]
              - generic [ref=f1e27]:
                - generic [ref=f1e28]:
                ...
                - generic [ref=f1e31]:
                  - textbox "Enter your password" [ref=f1e32]
                  - button [ref=f1e33]
...
> 34 |     await this.page.goto('/');
     |                     ^ Error: page.goto: Test timeout of 30000ms exceeded.
  35 |     await this.page.waitForURL(/auth\/login/, { timeout: 10000 });
  36 |   }
  37 | 
